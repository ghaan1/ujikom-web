        ...
        <div class="row">
            <div class="col">
                <div class="page-description">
                    ...
                    <span>Ubahlah data kategori. Jika sudah selesai, jangan lupa untuk mengklik tombol "Simpan"</span>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form id="kategoriSuratForm" action="{{ route('kategori-surat.update', $kategoriSurat->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="id_kategori_surat" class="form-control"
                                    value="{{ $kategoriSurat->id }}" disabled>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nama_kategori_surat"
                                    ...
                                    value="{{ old('nama_kategori_surat', $kategoriSurat->nama_kategori_surat) }}" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="keterangan_kategori_surat" class="form-control @error('keterangan_kategori_surat') is-invalid @enderror"
                                    required>{{ old('keterangan_kategori_surat', $kategoriSurat->keterangan_kategori_surat) }}</textarea>
